...
<!--div class="mui-content">
			<div id="slider" class="mui-slider" data-slidershowtimer="48">
			...
			<div class="uk-margin">
				<ul class="mui-table-view mui-grid-view mui-grid-8 line-height-normal">
					<li class="mui-table-view-cell mui-media mui-col-xs-6">
						<a class="tm-media-item checklogins" href="<?=url(['user/gener'])?>">
					...
					<li class="mui-table-view-cell mui-media mui-col-xs-6">
						<a class="tm-media-item checklogin" href="<?=url(['user/message'])?>">
					...
					<li class="mui-table-view-cell mui-media mui-col-xs-6">
						<a class="tm-media-item checklogin" href="<?=url(['user/task'])?>">
					...
					<li class="mui-table-view-cell mui-media mui-col-xs-6" style="display: ;">
						<a class="tm-media-item" href="<?=url(['user/information'])?>">
